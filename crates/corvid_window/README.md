...
| Frames a second | Turn for 2000 px, `delta` | `analog x dt` |
|---|---|---|
| 176 000 | 9.362 deg | 0.005 deg |
| 216 | 9.366 deg | 4.542 deg |
| 82 | 9.373 deg | 12.115 deg |
| 41 | 9.373 deg | 24.481 deg |
...
24.481 deg once and 24.615 deg the next time -- because it is a function of how long
...
second of that steady sweep turns the camera by between 0.59 deg and 1.77 deg under
`analog x dt`: a factor of three between one tenth of a second and the next,
