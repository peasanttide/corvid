...
/// | Worst measured error | 0.9569 degrees |
/// | Mean measured error | 0.3370 degrees over the sphere |
///
...
/// most angle: the half-diagonal of a quantization cell there is `sqrt1.5/127`,
/// the radius is `1/sqrt3`, and the quotient is `sqrt4.5/127` radians -- 0.95703 degrees,
/// against 0.956822 degrees measured. The README has the seam's own bound and the
...
/// direction onto a 127-step grid and costs it up to 0.9569 degrees -- a `.into()` on
