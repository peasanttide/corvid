...
/// packing costs, which at `FineRotation`'s 0.0034 degrees is far below the degree
/// this asserts.
///
...
fn every_yaw_is_adjacent_to_its_neighbour() {
    ...
    assert!(worst < 1.0, "adjacent yaws differ by up to {worst} degrees");
}
...
///
/// A [`FineRotation`] is four sixteen-bit components, good to about 0.0034 degrees --
