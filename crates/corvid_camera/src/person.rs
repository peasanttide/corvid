...
impl FirstPerson {
    /// A quarter turn less a hair: 89 degrees, either side of level.
    ///
    ...
    ///
    /// A first-person camera is a way of working out where a camera should be;
    /// a [`Camera`] is the answer it gives, and it is what `Controller::look`
    /// hands to a renderer.
    #[must_use]
    #[inline]
