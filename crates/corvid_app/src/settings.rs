...
impl<G: Game> Settings<G> {
    ...
    /// [`Error::Setting`](crate::Error::Setting) if it is there and is not this game's settings.
    ...
    /// # Errors
    ///
    /// [`Error::Wrote`](crate::Error::Wrote) if the directory could not be made or the file could not
    /// be written, and [`Error::Encoded`](crate::Error::Encoded) if the settings could not be written
    /// down at all.
