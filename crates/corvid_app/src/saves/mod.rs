...
impl Saves {
    ...
    /// # Errors
    ///
    /// [`Error::Wrote`](crate::Error::Wrote) if the directory or the file will not take it, and
    /// [`Error::Encoded`](crate::Error::Encoded) if the session or the state will not serialize.
    ...
    /// # Errors
    ///
    /// [`Error::Read`](crate::Error::Read) for a directory that will not say.
    ...
    /// # Errors
    ///
    /// [`Error::Read`](crate::Error::Read) if the file is there and will not open, and
    /// [`Error::Saved`](crate::Error::Saved) for a file that is not a save this build can play.
...
/// # Errors
///
/// [`Error::Read`](crate::Error::Read) if the file will not open, and [`Error::Saved`](crate::Error::Saved) for a file
