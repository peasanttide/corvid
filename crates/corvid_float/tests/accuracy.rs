...
/// An integer power is a chain of multiplications in both implementations, so
...
fn integer_powers_match_the_intrinsic_including_at_the_exponent_s_edges() {
    ...
    same(corvid_float::powi(2.0, 0), 2.0_f32.powi(0), "powi(2, 0)");
    same(corvid_float::powi(0.0, 0), 0.0_f32.powi(0), "powi(0, 0)");
    same(
        corvid_float::powi(2.0, i32::MIN),
        2.0_f32.powi(i32::MIN),
        "powi(2, i32::MIN)",
    );
    same(
        corvid_float::powi(2.0, i32::MAX),
        2.0_f32.powi(i32::MAX),
        "powi(2, i32::MAX)",
    );
}
