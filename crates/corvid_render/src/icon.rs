...
impl fmt::Display for NotAnIcon {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(
            f,
            "an icon {} by {} needs {} pixels and was given {}",
            self.width,
            self.height,
...
impl core::error::Error for NotAnIcon {}
...
impl TryFrom<(u32, u32, Vec<Rgba8>)> for Icon {
    ...
    /// # Errors
    ///
    /// [`NotAnIcon`] when the pixel count is not `width × height`.
