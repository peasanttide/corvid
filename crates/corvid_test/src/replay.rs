...
/// about.
pub fn replays_to_itself<G: Game>(outcome: &Outcome<G>) -> Result<(), Failed> {
...
fn survived_the_round_trip<S: State>(live: &Session<S>, decoded: &Session<S>) -> Option<Diverged> {
...
fn marks(recorded: &HashTrace, computed: &HashTrace, at: corvid_time::Tick) -> What {
    What::Marks {
