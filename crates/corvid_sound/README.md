...
15.26 um, far past anything audible; an absolute position on an earth-scale world
...
| Quantity | Type | Why |
|---|---|---|
| Listener pose | [`FineTransform`] | world-scale position and a packed rotation, 32 bytes |
| Source and cue positions | [`FinePoint`] | +/-32.7 km at 15.26 um, as an offset from the listener |
